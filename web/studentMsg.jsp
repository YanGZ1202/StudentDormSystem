...
<div style="background-color: rgba(255,255,255,0.4);width: 100%;height: 900px;">
    <form name="recordForm" action="student" method="post" onsubmit="return checkStudent()">
        <div style="text-align:center; vertical-align:middle;margin-bottom: 30px;padding-top: 50px">
            <span style="font-size: 25px">学号：</span>
            <input id="studentId" name="studentId" value="" type="text" style="font-size: 25px">
        </div>
        <div style="text-align:center; vertical-align:middle;margin-bottom: 30px">
            <span style="font-size: 25px">姓名：</span>
            <input id="name" name="name" value="" type="text" style="font-size: 25px">
        </div>
        <div style="text-align:center; vertical-align:middle;margin-bottom: 30px">
            <span style="font-size: 25px">密码：</span>
            <input id="password" name="password" value="" type="text" style="font-size: 25px">
        </div>
        <div style="text-align:center; vertical-align:middle;margin-bottom: 30px;margin-right: 25px">
        ...
        <div style="text-align: center;padding-bottom: 20px">
            <input type="radio" name="opType" value="insert" style="width:15px;height:15px" checked/>
            <span style="font-size: 20px">添加信息&nbsp;&nbsp;&nbsp;&nbsp;</span>
            <input type="radio" name="opType" value="modify" style="width:15px;height:15px"/>
            <span style="font-size: 20px">修改信息&nbsp;&nbsp;&nbsp;&nbsp;</span>
            <input type="radio" name="opType" value="delete" style="width:15px;height:15px"/>
            <span style="font-size: 20px">删除信息</span>
        </div>
        <div style="text-align: center;padding-bottom: 20px">
    ...
    <div style="text-align: center;padding-bottom: 20px;">
        <h5 id="error"  style="color: red">${studentMsg}</h5>
    </div>
</div>
</body>
</html>
