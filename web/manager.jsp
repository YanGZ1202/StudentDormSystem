...
<div style="background-color: rgba(255,255,255,0.4);width: 100%;height: 900px;">
    <form name="recordForm" action="regRecord" method="post" onsubmit="return checkRecord()">
        ...
        <div style="text-align:center; vertical-align:middle;padding-bottom: 30px;width: 440px;margin-left: 718px">
            <span style="font-size: 25px;float: left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;备注：</span>
            <label>
                <textarea id="detail" name="detail" rows="5" style="width: 318px;font-size: 20px;font-weight: normal"></textarea>
            </label>
        </div>
    ...
    <div style="text-align: center;padding-bottom: 20px;">
        <h5 id="error"  style="color: red">${registerMsg}</h5>
    </div>
</div>
</body>
</html>
