...
<div style="background-color: rgba(255,255,255,0.4);width: 100%;height: 900px;">
    <div style="text-align: right;padding:10px">
        <button type="button" class="btn btn-default btn-sm active" style="width: 80px;font-size: 15px" onclick="location.href='outputStu'">导出数据</button>
    </div>
